    ...
    public partial class InitMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryModelPollModel", x => new { x.CategoriesId, x.PollsId });
                    table.ForeignKey(
                        name: "FK_CategoryModelPollModel_Categories_CategoriesId",
                        column: x => x.CategoriesId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryModelPollModel_Polls_PollsId",
                        column: x => x.PollsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryModelPollModel_PollsId",
                table: "CategoryModelPollModel",
                column: "PollsId");
